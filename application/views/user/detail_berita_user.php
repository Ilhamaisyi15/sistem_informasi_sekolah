                          ...
                          <div class="row no-gutters">
                              <div class="card-body">
                                  <div class="card-img-top">
                                      <img width="800px" height="400px" class="img-thumbnail" src="<?= base_url('asset/gambar/berita/') . $berita['foto']; ?>" alt="">
                                  </div>
                              </div>
                              <!-- </td>
                          </tr> -->
                              <div class="card-body">
                                  <div class="card-title">
                                      <h4 class="text-center text-bold"><?= $berita['judul'];  ?></h4>
                                  </div>
                              </div>
                              ...
                              <div class="card-body">
                                  <div class="card-subtitle">
                                      <p class="text-right"> <small><?= $berita['tanggal'];  ?> / <?= $berita['penulis']; ?> / <?= $berita['status']; ?>
                                          </small></p>
                                  </div>
                              </div>
                          </div>
